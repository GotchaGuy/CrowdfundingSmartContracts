...
contract Crowdfunding {
    ...
    // i will implement openzepellin ownable here instead of admin
    ...
    function contribute() public payable {
        ...
        require(msg.value >= minContribution, "The Minimum Contribution not met!");
        
        // incrementing the number of contributors the first time when 
    ...
    function getRefund() public {
        ...
        require(raisedAmount < fundGoal, "The goal was met");
    ...
    function makePayment(uint _requestNumber) public onlyAdmin {
        ...
        require(thisRequest.numberOfVoters > numberOfContributors / 2, "The request needs more than 50% of the contributors.");
